    ...
    <div id="about">
      <div className="about-section">
        <div className="about-text">
          ...
          <p>
            Results-driven software developer with experience in designing,
            developing, and deploying high-quality applications that address
            complex business and user needs.
          </p>
          ...
          <div className="skills-container">
            ...
            <div className="skills">
              <div className="skill-icon" title=".NET">
                <NetLogo />
              </div>
              <div className="skill-icon" title="C#">
                <CsharpLogo />
              </div>
              <div className="skill-icon" title="Microsoft Azure">
                <AzureLogo />
              </div>
              <div className="skill-icon" title="Azure Functions">
                <AzureFuncLogo />
              </div>
              <div className="skill-icon" title="React">
                <ReactLogo />
              </div>
              <div className="skill-icon" title="Microsoft Dynamics 365">
                <D365Logo />
              </div>
              ...
              <div className="skill-icon" title="Power Apps">
                <PowerAppsLogo />
              </div>
              <div className="skill-icon" title="Power Automate">
                <PowerAutomateLogo />
              </div>
              <div className="skill-icon" title="SQL">
                <SQLLogo />
              </div>
            </div>
          </div>
